...
namespace StaticArrayList
{
    public class CustomArrayList
    {
        ...
        ///</summary>
        ///<param name="index">
        ///Indexm at which the specified element is to be inserted
        ///</param>
        ...
        public void Insert(int index, object item)
        {
            ...
            ///The index of given element or -1 i not found
            ///</returns>
        ...
        ///<summary>
        ///Retrieve the element on the set index
        ///</summary>
        ...
        ///<summary>
        ///Removes the elements at the specified index
        ///</summary>
        ///<param name="index">
